$(function(){
	$(".header_main_lf .p3 span").hover(function(){
		$(".header_main_lf .p3 b").css("display","block");
//		$(".header_main_lf .p3 span").css("background","#FFFFFF");
	},function(){
		$(".header_main_lf .p3 b").css("display","none");
	});
